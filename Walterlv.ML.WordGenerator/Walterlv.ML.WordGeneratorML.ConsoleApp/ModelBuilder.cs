...
namespace Walterlv.ML.WordGeneratorML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\Developments\Open\Walterlv.Demo\Walterlv.ML.WordGenerator\Walterlv.ML.ModelGenerator\bin\Debug\net48\output.txt";
        private static string MODEL_FILEPATH = @"../../../../Walterlv.ML.WordGeneratorML.Model/MLModel.zip";

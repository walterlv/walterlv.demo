...
namespace Walterlv.Demo.Windows
{
    public class WindowBlur
    {
        ...
        {
            ((Window)sender).Loaded -= OnSourceInitialized;
            AttachCore();
        }
        ...
        {
            _window.Loaded += OnSourceInitialized;
        }

        private static int _blurOpacity = 0;
        private static int _blurBackgroundColor = 0xe1ae06;

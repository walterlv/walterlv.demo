...
namespace MSTest.Extensions.Contracts
{
    public static partial class ContractTest
    {
        ...
        public static ContractTestContext<T1, T2, T3, T4, T5, T6, T7> Test<T1, T2, T3, T4, T5, T6, T7>([NotNull] this string contract, [NotNull] Action<T1, T2, T3, T4, T5, T6, T7> testCase)
        {
            ...
            return new ContractTestContext<T1, T2, T3, T4, T5, T6, T7>(contract, testCase);
        }
        ...
        [System.Diagnostics.Contracts.Pure, NotNull, PublicAPI]
        public static ContractTestContext<T1, T2, T3, T4, T5, T6, T7> Test<T1, T2, T3, T4, T5, T6, T7>([NotNull] this string contract, [NotNull] Func<T1, T2, T3, T4, T5, T6, T7, Task> testCase)
        {
            if (contract == null) throw new ArgumentNullException(nameof(contract));
            if (testCase == null) throw new ArgumentNullException(nameof(testCase));

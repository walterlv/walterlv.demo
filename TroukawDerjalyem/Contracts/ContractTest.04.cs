...
namespace MSTest.Extensions.Contracts
{
    public static partial class ContractTest
    {
        ...
        public static ContractTestContext<T1, T2, T3, T4> Test<T1, T2, T3, T4>([NotNull] this string contract, [NotNull] Action<T1, T2, T3, T4> testCase)
        {
            ...
            return new ContractTestContext<T1, T2, T3, T4>(contract, testCase);
        }
        ...
        [System.Diagnostics.Contracts.Pure, NotNull, PublicAPI]
        public static ContractTestContext<T1, T2, T3, T4> Test<T1, T2, T3, T4>([NotNull] this string contract, [NotNull] Func<T1, T2, T3, T4, Task> testCase)
        {
            if (contract == null) throw new ArgumentNullException(nameof(contract));
            if (testCase == null) throw new ArgumentNullException(nameof(testCase));
